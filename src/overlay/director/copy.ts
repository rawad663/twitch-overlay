...
export const FATES = [
  ...
  "You will win an argument in the shower three hours too late.",
  "Someone is about to send a meme that is only funny to them. Laugh anyway.",
  "Your future self is already annoyed about the tab you just opened.",
  "You will mishear a name and commit to it for the rest of the night.",
  "The moon has seen your search history. It is choosing kindness.",
  "Chat is about to roast you. Lean into it.",
  "The song stuck in your head is staying. Name it or suffer.",
  "You left something on the counter. It knows.",
  "Your headphones are about to betray you in front of everyone.",
  "The universe wants you to stretch. It will settle for a sigh.",
  "You already know the answer. You came here to hear it out loud.",
  "Be kinder to the version of you that is still figuring it out.",
  "Whatever you are carrying, put it down for one song.",
  "The person you were last year would be proud. Sit with that.",
  "Not every silence needs filling. This one doesn't.",
  "The hard conversation gets easier the moment you start it.",
  "Rest is not a reward you have to earn first.",
  "Someone remembers a small kindness you already forgot.",
  "You do not have to be impressive to be wanted here.",
  ...
  "The unread message is not getting kinder in the dark.",
  "Take the walk. The thought you need is outside.",
  "A small plan beats a perfect one you never start.",
  "Look up from the screen once. The room is still there.",
  "A stranger will say something tonight that sticks. Keep an ear open.",
  "You will remember a name you thought you lost. Say it.",
];

/** Path of Exile oracle lines for !fatepoe. */
export const FATES_POE = [
